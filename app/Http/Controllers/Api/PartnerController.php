...
#[OA\Tag(name: "Partners", description: "Партнеры проектов")]
class PartnerController extends Controller
{
    ...
    #[OA\Get(
        ...
        summary: "Список партнеров проекта",
        description: "Возвращает пагинированный список партнеров для указанного проекта",
        tags: ["Partners"],
        parameters: [
            new OA\Parameter(
                name: "id",
    ...
    public function index(Request $request, int $id): JsonResponse
    {
        try {
            ...
            $result = $this->partnerService->getPartners($query);
